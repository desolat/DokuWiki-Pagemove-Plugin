...
class plugin_move_plan_test  extends DokuWikiTest {
    ...
    /* some mental image of an existing structure
    ...
    */
    ...
    function test_sorting() {
        ...
        $this->assertEquals('humans:programmers:andi', $sorted[4]['src']);
        $this->assertEquals('animals:monkey', $sorted[3]['src']);
        $this->assertEquals('yeti', $sorted[2]['src']);
        $this->assertEquals('animals:mammals:bear', $sorted[1]['src']);
        $this->assertEquals('humans:programmers', $sorted[0]['src']);
    }
