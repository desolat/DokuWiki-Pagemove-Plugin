...
$lang['js']['complete']        = 'Η λειτουργία μετακίνησης ολοκληρώθηκε';
$lang['js']['renameitem']      = 'Μετονομάστε αυτό το θέμα';
$lang['js']['add']             = 'Δημιουργήστε νέο χώρο για όνομα';
$lang['js']['duplicate']       = 'Λυπάμαι, "%s" υπάρχει ήδη στο χώρο ονόματος αρχείου.	';
$lang['noscript']              = 'Για μετονομασία  χρειάζεταιJavaScript	';
$lang['moveinprogress']        = 'Υπάρχει μια άλλη προσπάθεια μετακίνησης σε εξέλιξη , δεν μπορείτε να χρησιμοποιήσετε αυτό το εργαλείο τώρα.	';
