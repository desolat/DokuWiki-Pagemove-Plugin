...
$lang['mediaatticmoveerror']   = 'Οι συνημμένοι φάκελλοι του φακέλλου μέσων ενημέρωσης %s δεν μπόρεσε να μετακινηθεί. Παρακαλώ μετακινείστε τους χειροκίνητα.';
...
$lang['preview']               = 'Ελέγξετε τις αλλαγές που θα γίνουν.';
...
$lang['autoskip']              = 'Αγνοήστε τα λάθη και αφήσετε τις σελίδες ή φακέλλους που δεν μπορούν να μετακινηθούν';
$lang['autorewrite']           = 'Ξαναγράψετε τις ιστοσελίδες ακριβώς όταν έχει ολοκληρωθεί η μετακίνηση';
...
$lang['noaction']              = 'Δεν υπάρχουν συγκεκριμένες κινήσεις';
$lang['renamepage']            = 'Μετονομάστε την Σελίδα ';
$lang['cantrename']            = 'Η σελίδα δεν μπορεί να αλλάξει όνομα τώρα αμέσως. Παρακαλώ προσπαθήστε αργότερα';
